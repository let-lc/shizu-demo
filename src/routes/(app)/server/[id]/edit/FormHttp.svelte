<script lang="ts">
  ...
  import { type HttpFormData, httpFormSchema } from '$lib/types';
  ...
  export let data: HttpFormData;
  export let workflow: boolean;

  const form = superValidateSync(data, httpFormSchema);
</script>
...
>
  ...
  <div class="flex justify-between gap-2">
    <div class="flex gap-2">
      <Form.Button formaction="?/httpUpdate">Update</Form.Button>
